...
Route::get('admin/dashboard/Mensajes_administrator/getContacts', 'MessagesController@getContacts')->name('contacts.get');

/**
 * Get contacts no chat
 */
Route::get('/getContactsNoChat', 'MessagesController@getContactsNoChat')->name('contactsNotChat.get');
...
Route::post('admin/dashboard/Mensajes_administrator/favorites', 'MessagesController@getFavorites')->name('favorites');
