...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'Afri Nail art studio'),
    ...
    */
    'routes' => [
        ...
        // 'prefix' => env('CHATIFY_ROUTES_PREFIX', 'panel/Mensajes'),
        'prefix' => env('CHATIFY_ROUTES_PREFIX', 'admin/dashboard/Mensajes_administrator'),
