...
<head>
    ...
    <meta property="og:title"
        content="{{ config('app.name') }} Salón NAILS Ourense - {{ config('app.name') }} Salón Ourense">
    <meta property="og:description"
        content="Salón de Manicura y Pedicura en Ourense Bienvenid@s a {{ config('app.name') }} Nail art Studio. Somos un centro con una amplia variedad de tratamientos de manicura y pedicura junto con otros opciones destinadas a vuestra belleza. Te esperamos en Ourense. RESERVAR CITA PREVIA http://salonnail.kesug.com/ TRATAMIENTOS Uñas & Belleza Manicura rusa Cuidamos de tus uñas y hacemos que luzcan perfectas. […]">
    ...
    {{-- libreria para seleccionar imagenes con vista previa en un círculo --}}
...
<body class=" antialiased bg-light">
    ...
    <script>
        const apiKey =
            "AAPK5eb2850a48944a4aa03bc623ff6ce83d8EZPfBhRFfmpAKpHYqpDyuByIiTDR-kMlYyYgrHj5YVEuL3QnBLAtEmyvs29JPmc";
    </script>
    ...
    <script>
        $(document).ready(function() {
            ...
            initIsotope('.isotope-container', '.isotope-item', '*', '.isotope-filters [data-filter]',
                'data-filter');
...
<script>
    ...
    const baseCreateUrl = "{{ route('admin.clientes') }}";
</script>
@auth
    <script>
        const currentUser = {
